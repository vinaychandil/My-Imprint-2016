...
<body>
  ...
  <div class="fixed-action-btn" style="bottom: 295px; right: 0px;">
    <a class="btn btn-large red" style="padding-left: 40px;padding-right: 40px">VOTE NOW
    </a>
</div>
...
The 9 options have been categorized in 3 slabs, according to the sign-ups raised by the Class of 2015 at the end of campaigning. You may make your choice of Class Gift in every slab. So, vote for 3 class gifts, one in each slab.</p>
    ...
    <div class="row">
     <div class="col s12 l4 m4">
      <div class="card">
        <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="img/locker.png">
        </div>
        <div class="card-content">
        ...
        <div class="card-reveal">
          ...
          <p class="smalltext">Required in central library to ensure the safety of bags and books kept outside the library</p>
        </div>
      </div>
    </div>
    <div class="col s12 l4 m4">
...
+91 9800148553 </p>
  <div class="footer-copyright">
      <p class="text">&copy;Copyrights reserved 2016</p>
